...
#create file "plot4.png" with plot 4
library(datasets)
png(filename = "plot4.png",width = 480, height = 480, units = "px")
par(mfrow=c(2,2))
with(df,{
        plot(datatime,Global_active_power,type="l",ylab="Global Active Power",xlab="")
        plot(datatime,Voltage,type="l",ylab=colnames(Voltage),xlab="datetime")
        ...
        plot(datatime,Global_reactive_power,type="l",ylab=colnames(Global_reactive_power),xlab="datetime") 
